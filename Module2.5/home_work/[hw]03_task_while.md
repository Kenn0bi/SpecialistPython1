...
# Количество символов для вывода результата умножения в таблицу с учетом пробела. Пример: в числе n 2 разряда, то 2*"9", int("99")**2 даст число из 4 разрядов +1
k = len(str(int(len(n)*"9")**2))+1    
